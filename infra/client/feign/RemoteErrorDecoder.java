...
import com.example.Spot.global.infrastructure.client.feign.exception.RemoteCallFailedException;
import com.example.Spot.global.infrastructure.client.feign.exception.RemoteConflictException;
import com.example.Spot.global.infrastructure.client.feign.exception.RemoteNotFoundException;
import com.example.Spot.global.infrastructure.client.feign.exception.RemoteServiceUnavailableException;
