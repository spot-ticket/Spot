...
//    @GetMapping
//    public ApiResponse<List<MenuOptionAdminResponseDto>> getOptions(
//            @AuthenticationPrincipal CustomUserDetails user,
//            @PathVariable UUID storeId,
//            @PathVariable UUID menuId
//    ) {
//        List<MenuOptionAdminResponseDto> data = menuOptionService.getOptions(user.getUserEntity().getRole(), storeId, menuId);
//
