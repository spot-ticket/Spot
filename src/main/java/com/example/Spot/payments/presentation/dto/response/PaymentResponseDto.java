...
public class PaymentResponseDto {
    ...
    public record Confirm(
        ...
        @Schema(description = "승인 시간", example = "2024-01-05T15:30:00")
    ...
    public record PaymentDetail(
        ...
        @Schema(description = "결제 제목", example = "치킨 주문 결제")
        String title,

        @Schema(description = "결제 내용", example = "후라이드 치킨 1마리")
        String content,
        ...
        @Schema(description = "결제 생성 시간", example = "2024-01-05T15:30:00")
    ...
    public record PaymentList(
        ...
        @Schema(description = "총 결제 수", example = "10")
        int totalCount
    ) {}
    ...
    public record CancelList(
        @Schema(description = "취소 목록")
        List<CancelDetail> cancellations,

        @Schema(description = "총 취소 수", example = "5")
        int totalCount
    ) {}
